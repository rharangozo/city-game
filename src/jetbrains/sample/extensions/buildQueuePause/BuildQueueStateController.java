...
public class BuildQueueStateController extends BaseActionController {
  ...
  private CriticalErrors myCriticalErrors;
  ...
  private void init() {
    registerAction(new ControllerAction() {
      ...
      public void process(final HttpServletRequest request, final HttpServletResponse response, @Nullable final Element ajaxResponse) {
